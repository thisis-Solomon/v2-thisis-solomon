              ...
              <div>
                <ul className="flex flex-wrap">
                  {skill.tags.map((stack, i) => (
                    <li
                      key={i}
                      className="py-1 px-4 md:px-2.5 text-center text-sm  md:scale-100 bg-stone-400/20 shadow shadow-stone-100 dark:shadow-stone-600 dark:text-teal-500 filter md:backdrop-blur rounded-full flex items-center mb-1 mr-1 justify-center"
                    >
                      {stack}
                    </li>
                  ))}
